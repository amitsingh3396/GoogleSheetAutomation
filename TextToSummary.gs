/**
 * Generates summaries for texts in a spreadsheet.
 * @returns {void}
 */
...
/**
 * Generates a summary for the given text using the Generative Language API.
...
function generateSummary(text) {
  ...
  // Define your prompt
  var prompt = "Generate the summary for the given text: " + text;
